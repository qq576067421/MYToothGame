...
public class PlayerMatchView : Singleton<PlayerMatchView>
{
    ...
    public void SetpersonPlayerReadyPartitionRectf(int curPlayerCount, float[,] personPlayerReadyRectf)
    {
        ...
        // 修改记录：2026-07-24 统一分区索引含义，索引0对应 Player0，索引1对应 Player1。
        // 摄像头画面在显示层存在左右翻转，这里在底层直接输出与 UI 座位一致的区域，
        // 上层不再为了人数和显示节点做反向映射。
        switch (curPlayerCount)
        {
            case 1:
                ...
                break;
            case 2:
                personPlayerReadyRectf[0, 0] = 0.55f; personPlayerReadyRectf[0, 1] = 0.0f; personPlayerReadyRectf[0, 2] = 0.75f; personPlayerReadyRectf[0, 3] = 0.9f;
                personPlayerReadyRectf[1, 0] = 0.25f; personPlayerReadyRectf[1, 1] = 0.0f; personPlayerReadyRectf[1, 2] = 0.45f; personPlayerReadyRectf[1, 3] = 0.9f;

                break;
            case 3:
                personPlayerReadyRectf[0, 0] = 0.6f; personPlayerReadyRectf[0, 1] = 0.0f; personPlayerReadyRectf[0, 2] = 0.8f; personPlayerReadyRectf[0, 3] = 0.9f;
                ...
                personPlayerReadyRectf[2, 0] = 0.2f; personPlayerReadyRectf[2, 1] = 0.0f; personPlayerReadyRectf[2, 2] = 0.4f; personPlayerReadyRectf[2, 3] = 0.9f;
                break;
            case 4:
                personPlayerReadyRectf[0, 0] = 0.625f; personPlayerReadyRectf[0, 1] = 0.0f; personPlayerReadyRectf[0, 2] = 1.0f; personPlayerReadyRectf[0, 3] = 0.9f;
                personPlayerReadyRectf[1, 0] = 0.5f; personPlayerReadyRectf[1, 1] = 0.0f; personPlayerReadyRectf[1, 2] = 0.625f; personPlayerReadyRectf[1, 3] = 0.9f;
                personPlayerReadyRectf[2, 0] = 0.375f; personPlayerReadyRectf[2, 1] = 0.0f; personPlayerReadyRectf[2, 2] = 0.5f; personPlayerReadyRectf[2, 3] = 0.9f;
                personPlayerReadyRectf[3, 0] = 0.1f; personPlayerReadyRectf[3, 1] = 0.0f; personPlayerReadyRectf[3, 2] = 0.375f; personPlayerReadyRectf[3, 3] = 0.9f;
                break;
            default:
