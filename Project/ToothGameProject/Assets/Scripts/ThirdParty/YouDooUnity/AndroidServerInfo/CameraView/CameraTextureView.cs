...
public class CameraTextureView : MonoBehaviour
{
    ...
    public void SetSmoothCalculator(CameraTextureViewSmoothCalculation smoothCalculator)
    {
        if (smoothCalculator == null)
        {
            return;
        }

        _smoothCalculator = smoothCalculator;
    }

    public void SetSmoothConfig(float smoothSpeed, float filterSpeed, float deadzone)
    {
        ...
        _smoothCalculator.SetSmoothConfig(smoothSpeed, filterSpeed, deadzone);
    }

    public void ResetSmoothState()
    {
        _smoothCalculator?.ResetSmoothState();
    }
