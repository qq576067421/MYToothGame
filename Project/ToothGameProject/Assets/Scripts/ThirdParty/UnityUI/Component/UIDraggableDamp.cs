...
namespace UnityUI
{
    ...
    /// 功能最为完善的UI移动
    /// </summary>
    public class UIDraggableDamp : UIBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        ...
        protected override void Awake()
        {
            ...
            {
                this.m_Canvas = this.m_Target.GetComponentInParent<Canvas>();
            }
            else
            {
