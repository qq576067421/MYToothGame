...
namespace UnityUI
{
    ...
    public class LoopListViewEditor2 : Editor
    {
        ...
        SerializedProperty mPerCount;
        SerializedProperty mSplitTime;
        ...
        GUIContent mPerCountGuiContent = new GUIContent("PerCount");
        GUIContent mSplitTimeGuiContent = new GUIContent("SplitTime");
        ...
        protected virtual void OnEnable()
        {
            ...
            mPerCount = serializedObject.FindProperty("m_PerCount");
            mSplitTime = serializedObject.FindProperty("m_SplitTime");
        ...
        void ShowItemPrefabDataList(LoopListView2 listView)
        {
            ...
            listView.ParentListView = (LoopListView2)EditorGUILayout.ObjectField("父列表",listView.ParentListView, typeof(LoopListView2), true);
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(mPerCount, mPerCountGuiContent);
            EditorGUILayout.PropertyField(mSplitTime, mSplitTimeGuiContent);
