...
namespace UnityUI
{
    public class UIFrameAnimation : MonoBehaviour
    {
        ...
        //目标SpriteRenderer组件
        public SpriteRenderer m_TargetSpriteRenderer;
        //当前帧索引
        ...
        void Start()
        {
            ...
            //m_TargetSpriteRenderer = this.GetComponent<SpriteRenderer>();
#if UNITY_EDITOR
            if (m_TargetImage == null && m_TargetSpriteRenderer == null)
            {
        ...
        private void DoUpdate()
        {
            ...
            {
                m_TargetImage.sprite = frames[currentFrameIndex];
            }
            else if (m_TargetSpriteRenderer != null)
            {
                m_TargetSpriteRenderer.sprite = frames[currentFrameIndex];
            }
            //设置计时器为当前时间
