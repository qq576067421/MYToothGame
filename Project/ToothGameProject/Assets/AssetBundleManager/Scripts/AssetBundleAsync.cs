...
namespace AssetBundles
{
    ...
    public class AssetBundleAsync : IEnumerator
    {
        ...
        public AssetBundleAsync(string bundleName, bool fullPath, Action<string, bool, Action<AssetBundle>> callToAction)
        {
            IsDone = false;
            callToAction(bundleName, fullPath, OnAssetBundleComplete);
        }
