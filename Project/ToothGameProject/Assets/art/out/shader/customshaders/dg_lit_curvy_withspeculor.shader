...
Shader "dg/dg_lit_curvy_withSpeculor"
{
	Properties
	{
...
#define CURVEDWORLD_BEND_ID_1
		...
		#pragma shader_feature_local _ _ALPHAPREMULTIPLY_ON
			...
			) : SV_Target
			{
				...
				float __specularRoughnessPbr = ( _SpecularRoughnessPBR * __albedo.a );
...
/* TCP_DATA u config(ver:"2.9.21";unity:"2022.3.62t7";tmplt:"SG2_Template_URP";features:list["ENABLE_FORWARD_PLUS","UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","SPECULAR","RIM","RIM_LIGHTMASK","SHADOW_COLOR_MAIN_DIR","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","CURVED_WORLD_2020","FOG","MATCAP_SHADER_FEATURE","AUTO_TRANSPARENT_BLENDING","SPECULAR_SHADER_FEATURE","SPEC_PBR_GGX","DISSOLVE","DISSOLVE_SHADER_FEATURE","DISSOLVE_GRADIENT","DISSOLVE_CLIP","TEMPLATE_LWRP","ALPHA_TESTING","ALPHA_TESTING_DITHERING"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting",RENDER_TYPE="TransparentCutout",CURVED_WORLD_2020_INCLUDE="Assets/PluginAssets/Amazing Assets/Curved World/Shaders/Core"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:True;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_MainTex";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"4030e6dc-614f-4a02-b744-6c40b441e248";op:Multiply;lbl:"Albedo";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,sp(name:"Alpha";imps:list[imp_spref(cc:1;chan:"A";lsp:"Main Color";guid:"4994ea14-f6b8-429a-95c0-7589c7d5ceb6";op:Multiply;lbl:"Alpha";gpu_inst:False;dots_inst:False;locked:False;impl_index:1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,,,,,sp(name:"Specular Roughness PBR";imps:list[imp_mp_range(def:0.5;min:0;max:1;prop:"_SpecularRoughnessPBR";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"d374bc1a-b703-404f-9869-ed58b5f7991f";op:Multiply;lbl:"Roughness";gpu_inst:False;dots_inst:False;locked:False;impl_index:0),imp_spref(cc:1;chan:"A";lsp:"Albedo";guid:"579daee3-2421-4a11-87fe-970bb003dd38";op:Multiply;lbl:"Specular Roughness PBR";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,,,,,,sp(name:"Dissolve Gradient Texture";imps:list[imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:True;cc:4;chan:"RGBA";prop:"_DissolveGradientTexture";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"1efc130b-e046-46bc-b501-af04c3d3c9a9";op:Multiply;lbl:"Gradient Texture";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,,,,,,,,,,,,,,,sp(name:"Specular Smoothness";imps:list[imp_mp_float(def:0.2;prop:"_SpecularSmoothness";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"2dd14bb3-950a-4d89-bc10-4081eabe78d8";op:Multiply;lbl:"Smoothness";gpu_inst:False;dots_inst:False;locked:False;impl_index:0),imp_spref(cc:1;chan:"A";lsp:"Albedo";guid:"4096596a-9072-42f9-b159-a53c96db3c1c";op:Multiply;lbl:"Specular Smoothness";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Emission";imps:list[imp_mp_color(def:RGBA(0, 0, 0, 1);hdr:True;cc:3;chan:"RGB";prop:"_Emission";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"84301501-636e-40de-a68e-52353fa81b30";op:Multiply;lbl:"Emission Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1),imp_vcolors(cc:3;chan:"AAA";linear:False;guid:"3756428c-99e2-4293-92a4-317d82550f48";op:Multiply;lbl:"Emission";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH d5e8c9e41a03eabe298e8684ca11ee16 */
