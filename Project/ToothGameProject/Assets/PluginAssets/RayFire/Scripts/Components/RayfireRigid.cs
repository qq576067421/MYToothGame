...
namespace RayFire
{
    ...
    public class RayfireRigid : MonoBehaviour
    {
        ...
        void Reset()
        {
            ...
            meshFilter      = null;
            meshRenderer    = null;
            skinnedMeshRend = null;
            debrisList      = null;
            dustList        = null;
            restriction     = null;
            sound           = null;
            demolitionEvent = new RFDemolitionEvent();
            activationEvent  = new RFActivationEvent();
            restrictionEvent = new RFRestrictionEvent();
        }
        */
        ...
        { get {
                ...
                if (objectType == ObjectType.SkinnedMesh && skinnedMeshRend != null) return skinnedMeshRend.isVisible;
                return true;
        }}
