    ...
    public class RFReset
    {
        ...
        public static void ResetRigid (RayfireRigid scr)
        {
            ...
            if (scr.restriction != null)
                scr.restriction.InitRestriction (scr);
        }
        ...
        public static void Reset (RayfireRigid scr)
        {
            ...
            RFPhysic.SetSimulationType (scr.physics.rigidBody, scr.simulationType, scr.objectType, scr.physics.gr, scr.physics.si, scr.physics.st);
