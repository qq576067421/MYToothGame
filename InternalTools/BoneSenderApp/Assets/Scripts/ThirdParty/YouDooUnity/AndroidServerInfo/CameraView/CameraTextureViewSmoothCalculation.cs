...
public class CameraTextureViewSmoothCalculation
{
    ...
    public Rect CalculateUvRect(Rect originalRegion, float rawImageAspect, int imageWidth, int imageHeight)
    {
        // 1. 参数验证
        ...
        float clampedY = Mathf.Clamp(targetRect.y, 0f, 1f - targetRect.height);
